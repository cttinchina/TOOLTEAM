...
<div id="controlPanel">  
  ...
  <iframe id='target_upload' name='target_upload' src='' style='display: none'></iframe>  
    ...
    <input type="submit" name="uploadButton" id="uploadButton" value="start"/>  
    <input type="button" name="cancelUploadButton" id="cancelUploadButton" value="exit" onclick="return cancelUpload();"/><br>  
    </form>     
    <div id="progressBar">  
   </div>    
</div>  
